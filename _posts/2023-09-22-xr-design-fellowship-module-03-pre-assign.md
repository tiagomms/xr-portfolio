...
> Think about a museum experience about a topic that you are obsessed with, or one that you have experienced yourselves or dreamed about. What kind of world is/was the experience resembling?

Before going to Armenia, I was thinking in making a Museum on Schooling & Education. 

After going to Armenia, I imagined my client was TUMO. I thought of these 2 propositions:

- **In TUMO Boxes, could we set up Museums-through-the-Cloud with XR Headsets?**
- **If yes, how would they work?**

The first step of the project was to make a Concept Development using a [FigJam template](https://www.figma.com/file/xql8cEvDl0z7c2GEMN6NDY?locale=en&type=design) provided by XR Bootcamp & Don Carson. It probably made more sense, for the Museum on Schooling & Education, but I ended up with 2 iterations.

Here is what I ended up writing / thinking.

<div class="responsive-video-container">
  <div class="fluid-width-video-wrapper" style="padding-top: 56.25%;">
    <iframe style="border: 1px solid rgba(0, 0, 0, 0.1);" width="800" height="450" src="https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Ffile%2FF7e0SDiIKqeQzYyZjK52na%2FMuseums-through-the-Cloud---Module-3-Worldbuilding-Template%3Ftype%3Dwhiteboard%26node-id%3D0%253A1%26t%3DA9YSAdx5tvW3Dxkm-1" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
  </div>
</div>
...
For the first part of the pre-assignment, I made **Model-based Environment Crafting** using [ShapesXR](http://shapes.app). 

I made my own TUMO Box, set it up in a mountainous region in Armenia, with local teenagers arriving in a local bus van.

In ShapesXR:
- Imported the low-poly terrain model below to make the countryside. 
- From Figma, Imported the photos of a real TUMO box close to Gyumri and a Mandalorian Recording Set in which they used 360 circular mega-screen for total immersion.
- Placed a holonote explaining the project
