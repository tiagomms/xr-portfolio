...
gallery-shots:
  - url: /assets/images/xr-bootcamp/xr-design-fellowship/module/07/quest-shot01.png
    image_path: /assets/images/xr-bootcamp/xr-design-fellowship/module/07/quest-shot01.png
    alt: "Starting point"
    title: "Starting point"
  - url: /assets/images/xr-bootcamp/xr-design-fellowship/module/07/quest-shot02.png
    image_path: /assets/images/xr-bootcamp/xr-design-fellowship/module/07/quest-shot02.png
...
![Me actually playing my prototype in Unity]({{ site.url }}{{ site.baseurl }}/assets/images/xr-bootcamp/xr-design-fellowship/module/07/quest-shot02.png)
...
<div class="responsive-video-container" style="padding-bottom: 580px;">
  <div class="fluid-width-video-wrapper" style="padding-top: 580px;">
    <iframe height="560px" src="https://twitter.com/Lunayian/status/1743888916233556417?ref_src=twsrc%5Etfw" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
  </div>
</div>
...
**Since we had less time to make a prototype (2 weeks), I chose to make a simple widget for meditation. Prepare a incense candle and have music and light help me in my meditation. As I wanted smoke and sound in my prototype, I used Unity to achieve that in the end. So let's dive right in.**
...
- Poly count and its topology (everything above 100k excluded, like the dragon incense burner)
- Usage of normal maps for added realism instead of additional poly count (example: the buddha and copper incense holder)
- Usability (if I had time, I would have added a meditation bowl for additional sound interaction - but it was not the main thing for the experience so I cut them)
- Issues with shaders: the shader used for both orbs were not supported by the gltfast extension used by Bezi. I didn't have much time and just wanted a nice looking orb - so the orb of Chi with some minor import changes in Unity looked pretty for prototyping purposes. If you want to dwell on the topic, here is a description of the technical issue - apparently I could have [imported the additional shaders by API](https://github.com/KhronosGroup/UnityGLTF?tab=readme-ov-file#unitygltf-and-gltfast), but it was quite a hassle for so little time (description of the [KHR_material_variants issue](https://github.com/KhronosGroup/UnityGLTF?tab=readme-ov-file#unitygltf-and-gltfast))! 

Regarding the poly count, topology and rendering maps - I used sketchfab layer tool to check each model wireframe and maps. You can see the gallery below to see how it looks like.
...
- similar setup work like in module 06
...
- some minor bug changes in my snap processing stages
- changed from the [Magical orb](https://sketchfab.com/3d-models/magical-orb-5e2e0ac919cb4d30ac022133086c088c) into the [Orb of Chi](https://sketchfab.com/3d-models/orb-of-chi-5b9b6b38c601459e95b24184d68e3255), because the package dependency that bezi integration uses (gltFast) did not support these types of materials - thus the animation never looked cool. 
...
This time was much faster because I had learned from my previous mistakes and I tried to keep it as a simple as possible due to the time frame.
