...
<div class="fluid-width-video-wrapper" style="padding-top: 0%;">
  <a id="assignment-module" target="_blank" href="https://space.shapes.app/space/share/fzd0dl4hsogp1h3syk3qlarehh_nzx7oiwnibn7n6spj/0/0" style="">
    ...
    <img class="w-[auto] h-[auto] max-h-[320px] object-center max-w-[480px]" srcset="{{ site.url }}{{ site.baseurl }}/assets/images/xr-bootcamp/xr-design-fellowship/general/shapesxr/2000x607.png 2000w, {{ site.url }}{{ site.baseurl }}/assets/images/xr-bootcamp/xr-design-fellowship/general/shapesxr/1600x486.png 1600w, {{ site.url }}{{ site.baseurl }}/assets/images/xr-bootcamp/xr-design-fellowship/general/shapesxr/1080x328.png 1080w, {{ site.url }}{{ site.baseurl }}/assets/images/xr-bootcamp/xr-design-fellowship/general/shapesxr/800x243.png 800w, {{ site.url }}{{ site.baseurl }}/assets/images/xr-bootcamp/xr-design-fellowship/general/shapesxr/500x152.png 500w, {{ site.url }}{{ site.baseurl }}/assets/images/xr-bootcamp/xr-design-fellowship/general/shapesxr/150x46.png 150w, {{ site.url }}{{ site.baseurl }}/assets/images/xr-bootcamp/xr-design-fellowship/general/shapesxr/2019x613.png 2019w" sizes="(max-width: 1024px) 100vw, 1024px">
  </a>
  <break/>
</div>
...
I ended going for the first one. It is a bit niche, but people that can't barely walk (due to muscular degeneration or inactivity after surgeries) tend to have a lot of limitations when it comes to exercising and higher chances of respiratory infections. 
