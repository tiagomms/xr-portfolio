---
title: "XR DF Module 08 - Assignment: XR Prototyping using Gen AI"
date: 2024-05-24T17:00:30+01:00
categories:
  - blog
tags:
  - XR
...
You may access the [project's repo here](https://github.com/tiagomms/xrdf-module06-bezishapes-unityIntegration) or you can actually [test the project build by downloading this folder](https://drive.google.com/drive/folders/1NxvkJMxLp5KyMjOVTRlYb42K0vj-_kBh?usp=share_link) into your Meta Quest. 
...
- 3D CSM
- MetaAvatar
- Bunch of image generators to create skyboxes: ManyWorlds.run, lexica.art, Adobe Firefly

### Project build versions & hardware
- Unity 2022.3.16f1
- Meta XR SDK All-in-one 62.0.0
